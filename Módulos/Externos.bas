...
'*
'*
'* Archivos Externos en  Virtual Martin temporize v1.7
'*
'*
'***************************************************************************
...
Public Sub guardar_Skins()
On Error GoTo no_se
 Open App.Path & "\Skins\Skins.inf" For Output As 1
 
 
 Print #1, frmprograma.File1.ListIndex
...
Public Sub Abrir_Skins()
Dim IndiceLista As String
 On Error GoTo no_se
 Open App.Path & "\Skins\Skins.inf" For Input As 1
 Do While Not EOF(1)
 Line Input #1, IndiceLista
 frmprograma.File1.ListIndex = CInt(IndiceLista)
 Loop
 Close #1
no_se:
End Sub
